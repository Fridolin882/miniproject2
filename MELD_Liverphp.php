...
<title>liver</title>
<center>
<form action="MELD_Liver.php" method="POST">
<h1>MELD(Age under 12)</h1><br></br>
<label for="Serum">Enter your Serum Creatinine(mg/dl)</label><br><br>
<input type="text" name="Serum"><br><br>
<label for"bilirubin">Enter your Bilirubin(mg/dl):</label><br><br>
<input type="text" name="bilirubin"<br><br>
<label for="ss">Enter your Serum Sodium(mg/dl):</label><br><br>
