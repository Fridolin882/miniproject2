...
<title>liver</title>
<center>
<form action="PELD_Liver.php" method="post">
<label for="id">ID</label><br>
<input type="text" name="uid" id="uid"><br><br>
<h1>PELD(Age 12 and older)</h1><br></br>
<label for="albumin">Enter your Albumin(mg/dl):</label><br><br>
<input type="text" name="albumin" id="albumini"><br><br>
<label for="bb">Enter your Bilirubin(mg/dl):</label><br><br>
<input type="text" name="bb" id="bb"><br><br>
<label for="INR">Enter your INR(mg/dl):</label><br><br>
<input type="text" name="INR" id="INR"><br><br>
